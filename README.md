...
graph TB
    subgraph world["ワールドマップ (50x50)"]
        ...
        subgraph north["── 北部 ──"]
            DC["🏰 まおうの城<br/>座標(24,5)<br/>ボス: まおう<br/>中ボス: あんこくきし<br/>宝箱: ひかりのつるぎ<br/>ひかりのよろい・ひかりのたて"]
            MT1["⛰️ 北西の山脈"]
            MT2["⛰️ 北東の山脈"]
        end
    ...
    ST -->|"北へ 川を渡る<br/>エンカウント: プヨプヨ コウモリ"| LK
    LK -->|"北西へ 山を越える"| CV
    CV -->|"ガーゴイル撃破<br/>→ アルテマ習得"| FR1
    FR1 -->|"東へ 川を渡る"| PT
    PT -->|"北西へ<br/>エンカウント: ガイコツ まどうし"| DC
    CV -->|"北へ<br/>エンカウント: ガイコツ まどうし"| DC
